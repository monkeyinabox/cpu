/* 
   ...
   bho1 7.11.2015 whole new setup with function table and alu op header comment
   bho1 10.10.2015 comment header for 6502 ALU operations
   GPL applies
...
/*
  ...
  *
  ...
  a + (255 - b) + c =
  a + !b + c
  accumulator := rega - regb - NOT(carryflag) = rega + NOT(regb) + carryflag
...
/*
  ...
  alu_table is a array of 17 pointers to function with parameterlist (char [], char[], char[],char []) returning void
