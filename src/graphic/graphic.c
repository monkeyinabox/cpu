...
void sdl_init(struct _vic* vic, unsigned int x_resolution, unsigned int y_resolution);
...
void sdl_init(struct _vic* vic, unsigned int x_resolution, unsigned int y_resolution){
  ...
  SDL_Window *sdlWindow = SDL_CreateWindow("6502asm.com: 32x32 screen from 0x0200 to 0x05ff",
